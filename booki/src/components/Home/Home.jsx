...
const Home = () => {
  ...
  return (
    <div className="w-full h-[400px] flex   items-center justify-center">
      <div className="relative w-[600px] h-[250px] border rounded-lg bg-white p-3 flex flex-col  justify-evenly items-center shadow-md">
        ...
        <div className="w-full flex justify-center mb-20 capitalize">
          ...
          {!isLoading ? (
            <button
              ...
              className="absolute top-38 right-[77px] text-[20px] bg-blue-400 px-3 py-6 rounded-[20px] text-white"
              onClick={() => handleBookSearch()}
            >
              Search
            </button>
          ) : (
            <button className="absolute top-38 right-[77px] text-[20px] bg-blue-400 px-3 py-6 rounded-[20px] text-white">
              <Loader />
            </button>
          )}
        </div>
